...
inputDevice = input("Укажите имя устройства: ")
inputParam = input("Укажите параметр (ios, model, vendor, location, ip): ")

print(london_co[inputDevice][inputParam])

#какое задание, такая реализация, либо я нихуя не понял
#не работает на 2.7
